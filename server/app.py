...
def bakeries():
    ...
    bakery_list = [{'id': bakery.id, 'name': bakery.name, 'baked_goods': [good.serialize() for good in bakery.baked_goods]} for bakery in all_bakeries]
...
def bakery_by_id(id):
    ...
    if bakery:
        bakery_data = {'id': bakery.id, 'name': bakery.name, 'baked_goods': [good.serialize() for good in bakery.baked_goods]}
